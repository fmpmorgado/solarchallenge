...
from src.trajectory.kepler import compute_kepler
...
def test_cowell_one_orbit_period(iss_orbit):
    ...
    r_cow, v_cow = propagate_cowell(orbit=iss_orbit, tofs=period)
...
def test_cowell_is_kepler(iss_orbit):
    ...
    r_cow, v_cow = propagate_cowell(orbit=iss_orbit, tofs=time_after_epoch)
